              ...
              <div class="d-flex">
                ...
                <v-card-title class="d-flex flex-column p-0 m-0">
                  ...
                  <v-card-text>
                    ...
                    <p><strong>Unidade de Medida:</strong> {{ produto.unidade_de_medida }}</p>
                    ...
                    <p><strong>Nome do Mercado:</strong> {{ produto.nome_mercado }}</p>
                    <h2 class="text-red"><strong>Preço:</strong> {{ produto.preco }}</h2>
                  </v-card-text>
                </v-card-title>
              </div>
            </v-card>
